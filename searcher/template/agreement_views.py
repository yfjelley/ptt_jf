...
"""
    ...
    for i in user:
        ...
        pr=Project(publish=i.user,status=status,active=active,name=u"魔镜在线",founder="yang",amount=200,finish=160,photo_url="/static/images/mojing.jpg",category=u"生活服务",introduction="魔镜在线-您的私人购物助理",leader=i.user)
